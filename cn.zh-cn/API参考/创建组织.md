...
<td class="cellrowborder" valign="top" width="13%" headers="mcps1.2.5.1.2 "><p id="p240910517419"><a name="p240910517419"></a><a name="p240910517419"></a>string</p>
</td>
<td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.5.1.3 "><p id="p1241035154112"><a name="p1241035154112"></a><a name="p1241035154112"></a>是</p>
</td>
...
<th class="cellrowborder" valign="top" width="13%" id="mcps1.2.5.1.2"><p id="p63228569414"><a name="p63228569414"></a><a name="p63228569414"></a>参数类型</p>
</th>
<th class="cellrowborder" valign="top" width="16%" id="mcps1.2.5.1.3"><p id="p83241756144115"><a name="p83241756144115"></a><a name="p83241756144115"></a>是否必选</p>
</th>
...
<td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.5.1.3 "><p id="p193261756154118"><a name="p193261756154118"></a><a name="p193261756154118"></a>是</p>
</td>
<td class="cellrowborder" valign="top" width="54%" headers="mcps1.2.5.1.4 "><p id="p2152015954"><a name="p2152015954"></a><a name="p2152015954"></a>组织名称，必须全局唯一。小写字母开头，后面跟小写字母、数字、下划线或中划线（其中下划线最多允许连续两个，并且不能直接与中划线相连），小写字母或数字结尾，1-64个字符。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="83.56%" headers="mcps1.2.3.1.2 "><p id="a1f2e8d58145d461781428d28f07a5351"><a name="a1f2e8d58145d461781428d28f07a5351"></a><a name="a1f2e8d58145d461781428d28f07a5351"></a>错误的请求或namespace个数超过上限</p>
</td>
</tr>
